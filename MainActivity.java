...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public void onButtonClickContent(View v) {
        _impressionistView.toggleComplementary();
    }
    ...
    public void onButtonClickCamera(View v) {
        boolean proceed = FileUtils.checkCamera(this);
        if (proceed) {
    ...
    public void onButtonClickSave(View v) {
        FileUtils.verifyStoragePermissions(this);
        Bitmap doodle = _impressionistView.getDoodle();

        String imgSaved = MediaStore.Images.Media.insertImage(
                getContentResolver(), doodle,
